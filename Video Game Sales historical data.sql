//*In This Project I clean and prepare data, I then go into a exploratory analysis examing multiple trends
the main component of this Project was joining tables*/

 --Cleaning and prepping the data, platform is null for the 2600 we will fix it up with a quick update command
